...
export default function ShareButton({ idRestaurant = "" }) {
    ...
    return (
        <Link className=" flex gap-2 mt-6 px-6 py-2 bg-blue-500 text-white rounded-xl hover:bg-blue-600" href={`https://www.facebook.com/share.php?u=${link}`} target="_blank" rel="noreferrer">
